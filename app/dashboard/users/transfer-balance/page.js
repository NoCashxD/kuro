...
export default function TransferBalancePage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-accent p-8 rounded-lg shadow-lg border border-gray-700">
      <h1 className="text-2xl font-bold text-text mb-6">Transfer Balance</h1>
      <form onSubmit={handleTransfer} className="space-y-4">
        <div>
          <label className="block text-sm text-gray-300">Recipient Username</label>
