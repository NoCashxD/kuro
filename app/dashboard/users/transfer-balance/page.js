    ...
    <div className="max-w-md mx-auto mt-10 bg-accent p-8 rounded-lg shadow-lg !border-none !border-none-gray-700 transfer">
      ...
      <form onSubmit={handleTransfer} className="space-y-4 keys">
        <div>
          ...
          <input type="text" className="w-full mt-1 p-2 rounded bg-gray-700 text-text !border-none !border-none-gray-600" required value={toUsername} onChange={e => setToUsername(e.target.value)} />
        </div>
        <div>
          <label className="block text-sm ">Amount</label>
          <input type="number" className="w-full mt-1 p-2 rounded bg-gray-700 text-text !border-none !border-none-gray-600" required value={amount} onChange={e => setAmount(e.target.value)} />
        </div>
